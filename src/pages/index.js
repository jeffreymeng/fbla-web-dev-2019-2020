...
const AirportSelect = ({id, onChange, value}) => {
  ...
  return (
    ...
    <Select id={id} filterOption={customFilterOption} options={options}  menuPlacement="top" style={{
      option:(...args) => {
        console.log("dfa", args)
      }
    }}
    components={{
      Option,
    ...
    noOptionsMessage={() => <><b>It looks like we may not fly to that airport yet!</b> Are you sure you spelled it correctly?</>}
