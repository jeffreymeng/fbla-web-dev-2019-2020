		  ...
		  <div class="relative lg:ml-10">
			...
			<blockquote>
			  <div class="text-2xl leading-9 font-medium text-gray-900">
				<p>
                  I thoroughly enjoy working at Coastal Airlines! Their employee benefits are unbelievable, and I love getting paid to travel.
				</p>
			  </div>
			  <div class="mt-8">
				<div class="flex">
				  ...
				  <div class="ml-4 lg:ml-0">
					<div class="text-base leading-6 font-medium text-grya-900">Jane Doe</div>
					<div class="text-base leading-6 font-medium text-indigo-600">Senior Flight Attendant</div>
				  </div>
				</div>
			  </div>
			</blockquote>
