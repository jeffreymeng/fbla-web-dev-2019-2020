...
<div class="relative bg-gray-900">
  ...
  <div class="relative max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    ...
    <div class="md:ml-auto md:w-1/2 md:pl-10">
      <div class="text-base leading-6 font-semibold uppercase tracking-wider text-gray-300">
        Our Special Specialty Program
      </div>
      <h2 class="mt-2 text-white text-4xl leading-9 font-bold tracking-normal sm:text-6xl sm:leading-tight"> Diamond Members<span className="text-indigo-600">.</span></h2>
      <p class="mt-3 text-xl leading-7 text-gray-300">If you earn more than 100,000 points, you automatically become a Diamond Beach Club+ Member.
     </p>
