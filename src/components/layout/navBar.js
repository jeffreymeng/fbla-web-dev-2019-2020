              ...
              <ClickAwayListener onClickAway={() => setUserNavOpen(false)} className="ml-3 relative">
                ...
                <Transition
                  ...
                  <div className="py-1 rounded-md bg-white shadow-xs">
                    ...
                    <Link to="/" onClick={(e) => {auth.signOut()}} className="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">Sign Out</Link>
                  </div>
                </Transition>
              </ClickAwayListener>
            </div>
